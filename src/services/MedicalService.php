...
use src\repositories\MedicalRepository;
...
class MedicalService
{
    ...
    {
        return (new MedicalRepository())->allWithPaginate();
    }
    ...
    function allOptions()
    {
        return (new MedicalRepository())->all()?->results;
    }
    ...
    {
        return (new MedicalRepository())->getByUserKey($userKey);
    }
    ...
    public function save(array $data)
    {
        ...
        $saved = (new MedicalRepository(
            (new Medical)->fill(array_merge(
        ...
        return (new Mailer(fromName: "UNASP - Portal"))
            ...
            ->setBody(
                str_replace(
                    ...
                    file_get_contents(base_url() . "/public/emails/credentialsDoctor.html")
                )
            )
            ->fire();
    }
    ...
    */
    ...
    public function lastInserted()
    {
        ...
        return (new MedicalRepository)->getLastInsertedId();
    }
    ...
    {
        return (new MedicalRepository())->byId($id)?->results;
    }
    ...
    public function filter(string $queryParam): ?BaseRepository
    {
        ...
        return (new MedicalRepository())->filterMedical($queryParamTrim);
    }
    ...
    function authenticate(array $dataFromForm): ?array
    {
        ...
        $medical = (new MedicalRepository())->getByDocument($user_key);
        if (!$medical or $medical->deleted_at)
            return null;
        // dd($password, $medical->password);
        return password_verify($password, $medical->password) ?
            setSession(
                AUTHENTICATION_SESS,
                array_only((array) $medical, [
                    "id",
                    "name",
                    "email",
                    "user_key",
