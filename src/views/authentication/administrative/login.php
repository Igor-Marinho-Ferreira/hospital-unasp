<?php $this->layout("globals/authentication/global", [
    "subheaderMessage" => "Prezado(a), colaborador, <br>seja bem-vindo(a) ao menu administrativo",
    "js" => [
...
<!-- form -->
<form action="<?= route(AUTH . AUTH_LOGIN_ADMINISTRATIVE_STORE) ?>" method="post">
    ...
    <div class="d-flex mb-3 align-items-center">
        <span class="ml-auto"> <a href="<?= route(AUTH . AUTH_RESET_ADMINISTRATIVE) ?>" class="forgot-pass">Esqueceu sua senha?</a></span>
    </div>
