        ...
        <header>
            <div class="image-text">
                ...
                <div class="text logo-text">
                    <span class="name">PAINEL <br> DO USUARIO</span>
                </div>
            </div>
        ...
        <div class="menu-bar">
            <div class="menu">
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link <?= routerIs("/appointment"); ?>">
                        <a href="<?= route(PATIENT . PATIENT_APPOINTMENT) ?>">
            ...
            <div class="bottom-content">
                <li class="">
                    <a href="<?= route(PATIENT . AUTH_LOGOUT_PATIENT . user("id")); ?>">
