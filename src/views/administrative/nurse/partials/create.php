<form class="row mb-2" method="POST" action="<?= route(ADMINISTRATIVE . ADMINISTRATIVE_NURSE_STORE) ?>" id="formNurseCreate">
    ...
    <div class="col-12 col-md-4 mb-3">
        ...
        <input type="text" class="form-control form-control-sm <?= applyWrong("crm") ?>" name="crm"
            id="crm" placeholder="Informe a descrição" maxlength="11" required
    ...
    <div class="col-12 col-md-4 mb-3">
        ...
        <select name="department_id" id="departmentsId" class="form-select form-select-sm <?= applyWrong("department_id") ?>" required>
