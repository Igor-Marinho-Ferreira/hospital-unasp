...
<div class="modal fade" id="modalUpdate" tabindex="-1" aria-labelledby="modalUpdateLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="modal-content" method="POST"
            action="<?= route(ADMINISTRATIVE . ADMINISTRATIVE_DEPARTMENTS_UPDATE) ?>">
            ...
            <div class="modal-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm <?= applyWrong("description") ?>"
                            name="description" id="descriptionUpdate" placeholder="Informe a descrição" maxlength="50" required
