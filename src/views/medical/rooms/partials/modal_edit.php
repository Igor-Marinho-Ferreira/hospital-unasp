...
<div class="modal fade" id="modalUpdate" tabindex="-1" aria-labelledby="modalUpdateLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form class="modal-content" method="POST"
            action="<?= route(MEDICAL . MEDICAL_ROOMS_UPDATE) ?>">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm <?= applyWrong("code") ?>" name="code"
                            id="codeUpdate" placeholder="Informe o código" maxlength="6" required
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm <?= applyWrong("description") ?>" name="description"
                            id="descriptionUpdate" placeholder="Informe a descrição" maxlength="6" required
